...
* **fig3.py:** This script containt the implementation of the 29 population rate model (based on the empirical connectivity matrix) that generates figure 3 from the original publication.
* **fig5_6.py:** This script containt the implementation of the 29 population spiking-neuron model that generates figure 5 and figure 6 from the original publication.
