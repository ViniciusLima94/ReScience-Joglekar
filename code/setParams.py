...
def get_params_spiking_model(dt, reg="async", gba="weak-gba"):
    ...
    inputs = {}
    inputs["async"] = {
        "weak-gba": {"t_on": 500.0, "t_off": 650.0, "I": 300.0},
        "strong-gba": {"t_on": 500.0, "t_off": 650.0, "I": 126.0},
    }
    inputs["sync"] = {
        "weak-gba": {"t_on": 500.0, "t_off": 508.0, "I": 200.0},
        "strong-gba": {"t_on": 500.0, "t_off": 508.0, "I": 200.0},
    }
    ...
    exc_Cm = (tau_ex / R) * 1000.0
    in_Cm = (tau_in / R) * 1000.0
